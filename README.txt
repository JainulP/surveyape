...
Clone repository
Install Node.js to location of directory SurveyApeFrontEnd
Install NPM to location of directory
Run "npm install" to load all node dependencies
Run frontend application by "npm start"
Install Java JDK 1.8.1
Maven import to root SurveyApe directory location
Run "mvn clean package" to root SurveyApe directory
Run "java -jar  <SNAPSHOT jar name>"
